...
def portfolio(request):
	...
	context = {
		...
		"skill_categories": SkillCategory.objects.prefetch_related("skills").order_by("title"),
		"projects": Project.objects.prefetch_related("tech_stack", "tools").order_by("title"),
		"experiences": Experience.objects.prefetch_related("skills").order_by("company"),
